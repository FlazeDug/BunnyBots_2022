...
import frc.lib.ctre.*;
import frc.lib.rev.NeoDriveControllerFactoryBuilder;
import frc.lib.rev.NeoSteerConfiguration;
import frc.lib.rev.NeoSteerControllerFactoryBuilder;
...
public final class Mk3SwerveModuleHelper {
    ...
    private static SteerControllerFactory<?, NeoSteerConfiguration<MagEncoderAbsoluteConfiguration>> getNeoSteerFactory(Mk3ModuleConfiguration configuration) {
